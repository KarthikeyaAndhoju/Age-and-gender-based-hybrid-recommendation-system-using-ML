...
import os 
import pickle
path="C:/Users/Koushik/Desktop/mini/UTKFace/"
...
h = model.fit(x_train,[y_train[:,0],y_train[:,1]],validation_data=(x_test,[y_test[:,0],y_test[:,1]]),epochs = 20, batch_size=128,shuffle = True)
